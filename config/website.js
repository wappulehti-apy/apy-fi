...
const LogoAjaton = '/ajaton/logos/logo-ajaton.png';
...
const Logo2019 = '/2019/logos/logo-2019.png';
...
module.exports = {
  ...
  siteFavicon16x16:
    theme === 'ajaton' ? favicon16x16_Ajaton : favicon16x16_2019,
  siteFavicon32x32:
    theme === 'ajaton' ? favicon32x32_Ajaton : favicon32x32_2019,
  siteFavicon: theme === 'ajaton' ? favicon_Ajaton : favicon_2019,
  siteAppleTouchIcon:
    theme === 'ajaton' ? appleTouchIconAjaton : appleTouchIcon2019,
  siteSafariPinnedTag:
    theme === 'ajaton' ? safariPinnedTagAjaton : safariPinnedTag2019,
